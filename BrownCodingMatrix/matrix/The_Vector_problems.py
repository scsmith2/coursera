...
p3_vector_sum_1 = [[0,one,one][i]+[one,one,one][i] for i in range(len([0,one,one]))]
p3_vector_sum_2 = [[0,one,one][i]+[one,one,one][i]+[one,one,one][i] for i in range(len([0,one,one]))]
